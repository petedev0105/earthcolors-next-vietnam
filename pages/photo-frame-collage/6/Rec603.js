          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="2"
                style={{ left: 822, top: 122 }}
              >
                <img
                  src={`/img/${activeMaterial}/F021.png`}
                  className="2"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="4"
                style={{ left: 800, top: 260 }}
              >
                <img
                  src={`/img/${activeMaterial}/F006.png`}
                  className="4"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
