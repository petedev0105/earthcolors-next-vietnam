          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                ...
                id="1"
                style={{ left: 632, top: 264 }}
              >
                <img
                  src={`/img/${activeMaterial}/F007.png`}
                  className="1"
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="3"
                style={{ left: 892, top: 193 }}
              >
                <img
                  src={`/img/${activeMaterial}/F008.png`}
                  className="3"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
