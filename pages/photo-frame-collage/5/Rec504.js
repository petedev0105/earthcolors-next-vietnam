    ...
    <div className="mainContainer">
      <div className="comboContainer" ref={exportRef}>
        <div className="comboCenter">
          ...
          >
            <div>
              <img src={wallPaper} style={{ height: 900, width: 1600, objectFit: "cover" }} />
            </div>
            <div>
              <img
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="2"
                style={{ left: 760, top: 191 }}
              >
                <img
                  src={`/img/${activeMaterial}/F018.png`}
                  className="2"
                    onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="4"
                style={{ left: 839, top: 227 }}
              >
                <img
                  src={`/img/${activeMaterial}/F016.png`}
                  className="4"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="5"
                style={{ left: 951, top: 265 }}
              >
                <img
                  src={`/img/${activeMaterial}/F019.png`}
                  className="5"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
