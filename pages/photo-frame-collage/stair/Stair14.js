...
function Rec301() {
  ...
  var [tenthImgSrc, setTenthImgSrc] = useState("/img/web/add.png");
    ...
    if (e.target.files && e.target.files.length > 0) {
      ...
      switch (chosenImageClassName) {
        ...
        case "9":
          ...
          break;
        case "10":
          setTenthImgSrc(imageFile);
          insertImage(imageFile, 10);
          break;
        default:
          break;
      }
          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="3"
                style={{ left: 696, top: 148 }}
              >
                <img
                  src={`/img/${activeMaterial}/F047.png`}
                  className="3"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              ...
              >
               ...
               src={`/img/${activeMaterial}/F009.png`}
                ...
                <div
                  style={{
                    backgroundImage: `url(${tenthImgSrc})`,
                  }}
                ></div>
              </div>
            </Draggable>
