        ...
        <div className="comboCenter">
          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="1" style={{ left: 571, top: 130 }}>
                <img
            ...
            ;{/* F0044 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="2" style={{ left: 677, top: 122 }}>
                <img
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                ...
                id="3"
                style={{ left: 677, top: 192 }}
              >
                <img
                 src={`/img/${activeMaterial}/F014.png`}
                  className="3"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            {/* F0044 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="4" style={{ left: 765, top: 340 }}>
                <img
                  src={`/img/${activeMaterial}/F044.png`}
                  className="4"
                  onClick={handleImageClick}
            ...
            ;{/* F0035 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="5" style={{ left: 832, top: 276 }}>
                <img
                 src={`/img/${activeMaterial}/F035.png`}
                  className="5"
                  onClick={handleImageClick}
