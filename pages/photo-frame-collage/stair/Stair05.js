        ...
        <div className="comboCenter">
          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="1" style={{ left: 602, top: 143 }}>
                <img
            ...
            ;{/* F0011 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="2" style={{ left: 710, top: 159 }}>
                <img
                  src={`/img/${activeMaterial}/F011.png`}
                  className="2"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            ;{/* F0044 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="3" style={{ left: 711, top: 293 }}>
                <img
                  src={`/img/${activeMaterial}/F044.png`}
                  className="3"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            ;{/* F0044 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="4" style={{ left: 772, top:293 }}>
                <img
                  src={`/img/${activeMaterial}/F044.png`}
                  className="4"
                  onClick={handleImageClick}
            ...
            ;{/* F0044 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="5" style={{ left: 834, top: 293 }}>
                <img
                 src={`/img/${activeMaterial}/F044.png`}
                  className="5"
                  onClick={handleImageClick}
            ...
            ;{/* F0035 */}
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div className="comboImage" id="6" style={{ left: 904, top: 311 }}>
                <img
                 src={`/img/${activeMaterial}/F035.png`}
                  className="6"
                  onClick={handleImageClick}
