          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                ...
                id="1"
                style={{ left: 567, top: 159 }}
              >
                <img
                  src={`/img/${activeMaterial}/F031.png`}
                  className="1"
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="2"
                style={{ left: 567, top: 331 }}
              >
                <img
                  src={`/img/${activeMaterial}/F037.png`}
                  className="2"
                 onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
