          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="2"
                style={{ left: 592, top: 341 }}
              >
                <img
                  src={`/img/${activeMaterial}/F041.png`}
                  className="2"
                 onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="5"
                style={{ left: 735, top: 369 }}
              >
                <img
                 src={`/img/${activeMaterial}/F015.png`}
                  className="5"
                 onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
