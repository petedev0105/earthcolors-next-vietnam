          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                ...
                id="1"
                style={{ left: 527, top: 140 }}
              >
                <img
                  src={`/img/${activeMaterial}/F038.png`}
                  className="1"
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="3"
                style={{ left: 638, top: 140 }}
              >
                <img
                  src={`/img/${activeMaterial}/F039.png`}
                  className="3"
                 onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="4"
                style={{ left: 638, top: 364 }}
              >
                <img
                  src={`/img/${activeMaterial}/F005.png`}
                  className="4"
                 onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
