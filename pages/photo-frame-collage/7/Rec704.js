          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="4"
                style={{ left: 789, top: 145 }}
              >
                <img
                  src={`/img/${activeMaterial}/F032.png`}
                  className="4"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="7"
                style={{ left: 945, top: 291 }}
              >
                <img
                  src={`/img/${activeMaterial}/F028.png`}
                  className="7"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
