          ...
          >
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                ...
                id="1"
                style={{ left: 592, top: 125 }}
              >
                <img
                  src={`/img/${activeMaterial}/F033.png`}
                  className="1"
            ...
            <Draggable bounds="parent" onDrag={handleDrag}>
              <div
                className="comboImage"
                id="2"
                style={{ left: 535, top: 310 }}
              >
                <img
                  src={`/img/${activeMaterial}/F034.png`}
                  className="2"
                  onClick={handleImageClick}
                  style={{ zIndex: 2, position: "relative " }}
                />
